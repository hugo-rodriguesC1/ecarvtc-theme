...
<div class="loop mt-28 sm:mt-24 bg-[#F3F5FF]">
    ...
    <div class="px-6 xs:px-10 sm:px-20 md:px-32 lg:px-40">
        ...
        <div class=" lg:flex justify-between w-full lg:gap-20 items-center ">
            ...
            <div>
                ...
                <p class=" text-sm font-medium">
                    ...
                    100%
                    électrique. Contrairement à la plupart des taxis et VTC de PMA (Pays de Montbéliard Agglomération)
                    qui
                    sont
            ...
            <img class=" mt-5 mb-10 lg:w-1/2 lg:m-0"
                src="<?php echo get_template_directory_uri(); ?>/img/a-propos-5.png" alt="paysage avec des arbres">
        </div>
        ...
        <div class=" lg:flex justify-between w-full lg:gap-20 items-center md-10 lg:mt-28">
            ...
            <div>
                ...
                <p class=" text-sm font-medium">
                    ...
                    arrêt de
                    mt-28 à 35mn suffit pour recharger les batteries, un arrêt détente pendant lequel votre chauffeur se
                    fera un
        ...
        <div class=" lg:flex justify-between w-full lg:gap-20 items-center mt-10">
            ...
            <div>
                ...
                <p class=" text-sm font-medium">
                    ...
                    30
                    années
                    d'expérience de la conduite automobile, qu'il a passées en tant que metteur au point chez PSA
                    Peugeot
                    Citroën (maintenant Stellantis). Cette activité de mise au point de prototypes l'a emmené sur des
                    routes
                    ...
                    anneaux
                    de vitesse (Mortefontaine, …), circuits sur terre (Trappes, …) et sur glace (Flaine, Älvsbyn en
                    Suède,
                    Vaalajärvi en Finlande).
                </p>
            </div>
            <img class=" mt-5 mb-10 lg:w-1/2 lg:m-0"
                src="<?php echo get_template_directory_uri(); ?>/img/a-propos-3.png" alt="paysage avec des arbres">
        </div>
        ...
        <div class=" lg:flex justify-between w-full lg:gap-20 items-center mt-10">
            <img class=" mt-5 mb-10 lg:w-1/2 lg:m-0 hidden lg:block"
                src="<?php echo get_template_directory_uri(); ?>/img/a-propos-4.png" alt="paysage avec des arbres">
            <div>
